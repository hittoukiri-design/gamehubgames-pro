...
<head>
  ...
  <meta name="description" content="<?= htmlspecialchars($description ?? 'YaarWin Games India platform for YaarWin login, Aviator, Teen Patti, Rummy, Wingo colour prediction, cricket betting, live casino, bonuses, UPI payment checks, fast withdrawal support, and mobile-first real-money game access.') ?>">
